...
from qupang.users import serializers as user_serializers
from qupang.notifications import views as notifications_views
...
class ImageDetail(APIView):
    ...
    def put(self, request, image_id, format=None):
        ...
        # IMPORTANT
        # USE "partial=True" to avoid filling all required field in the serializer
...
class ModerateComments(APIView):
    ...
    def delete(self, request, image_id, comment_id, format=None):
        ...
        # *** This is not a smart way to delete comments, ***
        # *** because it's getting two objects (image & comment both) ***
        # try:
        #     image = models.Image.objects.get(id=image_id, creator=user)
        # except models.Image.DoesNotExist:
        #     return Response(status=status.HTTP_404_NOT_FOUND)
        # try:
        #     comment_to_delete = models.Comment.objects.get(id=comment_id, image_id=image_id)
        try:
